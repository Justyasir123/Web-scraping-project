...
#         #     salary_list.append(salary.text.split(','))
...
#         if box:
#
#             salaries = box.find_all("span", {
#                 "class": "qualifications display-block modal-open pull-left job-details-span"})
#
#             for i in salaries:
#                 salary_list.append(i.text.split(','))
#             for i in range(len(salary_list)):
#                 if i % 2 == 0:
#                     salary_List.append(salary_list[i])
